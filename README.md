...
A self-paced course that empowers Treasury professionals to become internal champions for AI coding assistants like Windsurf.
...
1. **Windsurf Fundamentals** (30 min) - Cascade & Flows basics
2. **Cash Management Dashboard** (45 min) - Build yield curve tracker
3. **Debt Management Analysis** (45 min) - Compare company debt metrics
4. **Investments & Peer Analysis** (60 min) - Interactive peer comparison
5. **Automation & Reporting** (50 min) - Automated morning reports
6. **Troubleshooting & Best Practices** (30 min) - When to iterate vs restart
